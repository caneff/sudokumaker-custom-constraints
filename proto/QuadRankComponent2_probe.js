...
function * update (instance, puzzle) {
  try { yield * update0(instance, puzzle) } catch (e) {
    if (!globalThis.__qrerr) { globalThis.__qrerr = 1; console.log('[probe] ERR ' + e.message) }
  }
}

function * update0 (instance, puzzle) {
  globalThis.__qrcalls = (globalThis.__qrcalls || 0) + 1
  if (globalThis.__qrcalls % 20000 === 0) console.log('[probe] calls ' + globalThis.__qrcalls + ' stops ' + (globalThis.__qrstops || 0))
  ...
  if (rank - 1 < L || rank - 1 > P) {
    globalThis.__qrstops = (globalThis.__qrstops || 0) + 1
