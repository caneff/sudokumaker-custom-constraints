...
// The only deduction: the counting identity (#335). The leading-digit bound
// of #324 is deliberately absent -- this variant measures the identity alone. Rank R means exactly R-1 windows
...
function * update (instance, puzzle) {
  const { rank, allCells, cells, wins, me } = instance
  const n = instance.n
