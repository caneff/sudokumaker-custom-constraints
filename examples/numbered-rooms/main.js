// Numbered Rooms (escape-the-grid), LOCAL variant. One self-contained
// component per line does all the work — no split across a wrapper and a
// built-in. group.cells[0] is the outside clue; the rest is the line,
