...
// `puzzle.getCellAt(row, col)` = row*W+col [verified 2026-08-28 via a [probe]
// log in the app]. Every frame line is one row or column by construction, so
// no direction check is needed here (main.js keeps it, for a drawn group of
// any shape).
