"""Soundness suite for the Ghosts finder.

    uv run pytest finders/ghosts
...
# Notes, hit logs and images stayed under docs/research/ghosts when the code moved.
EXAMPLES = HERE.parents[1] / "docs" / "research" / "ghosts" / "examples-verified.jsonl"
...
def test_repeated_given_in_a_house_is_rejected():
    # An L of three: the two ends both see one ghost, and they share a box.
    shape = {0, 1, 9}
