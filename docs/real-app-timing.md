...
| ISOFILL (stripped, 44 givens, `puzzle-44.json`) | reach only ~25.9 s; reach + capacity **~9.1 s** (2026-08-26, 3/3 unique); + homeless ~9.1 s (no change) | — | capacity kept: 2.8× faster where the app closes at all (#90); homeless removed: no gain (#91) |
