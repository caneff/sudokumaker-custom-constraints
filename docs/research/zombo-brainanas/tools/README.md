...
- `checkset.py <found name> <clue> ...` — is one found fill the unique solution under a given clue set? Clues are circles (`r6c8`) and white dots (`r3c2-r3c3`); prints UNIQUE or the second solution.
