...
with those givens. Writes the solved grid (ghosts circled) and the puzzle view
(ghost cells circled with their digits, other cells blank).
"""
...
def draw(digits, ghosts, show_all, path):
