"""Throwaway probe: does a sudoku + ghost set exist with a ghost holding 8?

Rule: a ghost cell's digit equals the number of ghosts among its king-move
neighbours. Non-ghost cells are unconstrained.
"""
