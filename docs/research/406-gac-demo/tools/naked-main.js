// One NakedOnlyComponent per house of the inner grid: every row, every
...
for (const h of houses) puzzle.addConstraintComponent(new NakedOnlyComponent(h.name, h.cells))
