// One RefuterComponent per house of the inner grid: every row, every
...
for (const h of houses) puzzle.addConstraintComponent(new RefuterComponent(h.name, h.cells))
