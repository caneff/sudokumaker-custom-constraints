...
SURVIVORS = [
    {"Red": "nr", "Blue": "sky", "Purple": "out", "Green": "rs"},
    {"Red": "nr", "Blue": "out", "Purple": "sky", "Green": "rs"},
    {"Red": "rs", "Blue": "sky", "Purple": "out", "Green": "nr"},
    {"Red": "rs", "Blue": "out", "Purple": "sky", "Green": "nr"},
]
for assign in SURVIVORS:
    ...
    assert s.StatusName(s.Solve(m)) in ("OPTIMAL", "FEASIBLE")
    ...
    for c in sorted(need):
        for d in range(1, 7):
            ...
            st = s2.StatusName(s2.Solve(m2)); probes += 1
    ...
    label = " ".join(f"{k}:{v}" for k, v in assign.items())
